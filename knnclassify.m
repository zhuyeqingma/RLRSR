...
%
%   KNNCLASSIFY has been removed. Use fitcknn to fit a KNN classification
%   model and classify data using ClassificationKNN.predict.
%
...
error(message('bioinfo:knnclassify:FunctionToBeRemoved'));
